      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
            <p className="text-sm text-blue-700 font-medium mb-1">Manuel</p>
          ...
          <div className="p-4 bg-green-50 rounded-lg border border-green-200">
            <p className="text-sm text-green-700 font-medium mb-1">Pablo</p>
        ...
        {balance.deudor ? (
          <div className="p-4 bg-orange-50 rounded-lg border border-orange-200">
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="font-semibold text-orange-900">Compensación requerida</p>
            </div>
            <p className="text-lg text-orange-800">
              <span className="font-bold">{balance.deudor}</span> debe compensar{' '}
          ...
          <div className="p-4 bg-green-50 rounded-lg border border-green-200 text-center">
            ...
            <p className="font-semibold text-green-900">¡Gastos equilibrados!</p>
            <p className="text-sm text-green-700 mt-1">
              Ambos han gastado lo mismo este mes
            </p>
          </div>
        )}
      </div>
